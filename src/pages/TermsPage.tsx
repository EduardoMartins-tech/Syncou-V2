    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
      <header className="border-b border-border bg-background/90 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link to="/" className="text-sm text-muted-foreground hover:text-foreground flex items-center gap-2 transition-colors font-medium">
      ...
      <main className="flex-1 py-16 px-4">
        ...
        >
          <div className="flex items-center gap-4 mb-10">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground mb-2">Termos de Serviço</h1>
              <p className="text-muted-foreground text-sm md:text-base">Última atualização: {new Date().toLocaleDateString('pt-BR')}</p>
            </div>
          </div>

          <div className="prose prose-violet max-w-none prose-headings:text-foreground prose-p:text-muted-foreground prose-li:text-muted-foreground prose-strong:text-foreground space-y-6 text-muted-foreground leading-relaxed">

             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">1. Aceitação dos Termos</h2>
               <p>Ao acessar e utilizar a plataforma Syncou ("Plataforma", "Nós", "Nosso"), você ("Usuário", "Profissional", "Cliente") concorda integral e expressamente com os presentes Termos de Serviço. Caso não concorde com qualquer disposição aqui presente, você <strong className="text-foreground">não deve</strong> utilizar nossos serviços. O uso contínuo da Plataforma constitui aceitação irrefutável destes termos em sua totalidade e renúncia legal a qualquer contestação posterior contra o seu fornecedor.</p>
             </section>

             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">2. Natureza do Serviço e Proteção Legal</h2>
               <p>A Plataforma opera exclusivamente como uma infraestrutura tecnológica (SaaS) para facilitar o agendamento de horários entre Profissionais e seus respectivos Clientes. <strong className="text-foreground">A Plataforma é meramente um software intermediador e não é parte de nenhuma negociação, acordo, contrato ou transação do mundo real.</strong></p>
             ...
             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">4. Preservação de Dados e Tolerância a Falhas</h2>
               <p>Embora adotemos ferramentas para preservar as informações, <strong className="text-foreground">o Usuário é unicamente responsável por realizar seus próprios backups</strong> e anotações. Não haverá, sob pretexto algum, direito à indenização por exclusão acidental de dados, corrupção do banco de dados, pane no servidor ou interrupções provocadas por ataques cibernéticos ou força maior.</p>
             </section>

             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">5. Moderação, Conteúdo e Desligamento Unilateral</h2>
             ...
             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">6. Acordo Completo de Indenização</h2>
               <p>Ao se inscrever, você isenta permanentemente os gestores e desenvolvedores da Plataforma, concordando em não tomar nenhum tipo de atitude legal (<strong className="text-foreground">pleiteando e suportando até mesmo os custos de defesa e honorários advocatícios</strong> do "criador") nos casos de processo ou ameaça de processo gerado por sua decisão e escolha de usar nossos sistemas.</p>
             </section>

             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">7. Serviços e Atividades Proibidas</h2>
             ...
             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">8. Propriedade Intelectual</h2>
             ...
             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">9. Teto de Responsabilidade Financeira</h2>
               <p>Sem prejuízo das cláusulas de isenção já descritas, caso a Plataforma seja, por qualquer motivo legal, condenada a indenizar o Usuário, fica desde já pactuado que <strong className="text-foreground">a responsabilidade máxima agregada jamais ultrapassará o valor total pago pelo próprio Usuário à Plataforma nos últimos 12 meses</strong> (ou R$ 0,00 caso seja um usuário do plano gratuito).</p>
             </section>

             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">10. Alteração dos Termos</h2>
             ...
             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">11. Inexistência de Vínculo</h2>
             ...
             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">12. Falhas em APIs e Serviços de Terceiros</h2>
               <p>Nossa plataforma integra-se com serviços externos (ex: APIs do Google Calendar, WhatsApp, provedores de email). Nós <strong className="text-foreground">não temos controle</strong> sobre esses serviços. Se o Google alterar suas regras, cobrar taxas ou derrubar integrações, ou se o WhatsApp bloquear números ou links, a Plataforma não poderá ser responsabilizada por nenhuma perda de funcionalidade, atraso ou dados perdidos resultantes das ações destes terceiros.</p>
             </section>

             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">13. Responsabilidade Tributária, Fiscal e Consumerista</h2>
               <p>O Profissional é o único, exclusivo e integral responsável por recolher todos os impostos devidos (ISS, IRPF, IRPJ, etc.), emitir Notas Fiscais, respeitar orçamentos, seguir as regras do seu respectivo conselho de classe (CRM, CRP, OAB, etc.) e cumprir o Código de Defesa do Consumidor (CDC) perante seus Clientes. A Plataforma <strong className="text-foreground">exime-se expressamente de qualquer responsabilidade solidária ou subsidiária</strong> em auditorias fiscais, processos do Procon ou litígios consumeristas.</p>
             </section>

             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">14. Fraudes, Pagamentos e "Chargebacks"</h2>
             ...
             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">15. Capacidade Civilidade e Idade Mínima</h2>
             ...
             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">16. Cláusula de Salvaguarda (Divisibilidade)</h2>
             ...
             <section className="space-y-3">
               <h2 className="text-xl font-bold text-foreground mb-2 pb-2 border-b border-border inline-block">17. Renúncia Irrevogável a Ações Coletivas</h2>
               <p>O Usuário concorda de modo irretratável que toda e qualquer insatisfação, disputa ou possível pleito de reparação será resolvido em esfera <strong className="text-foreground">individual e restrita</strong>. Fica extinto, por meio de livre aceitação desses termos, ao direito de encabeçar, aderir ou apoiar judicialmente ou extra-judicialmente Ações Civis Públicas, Ação Coletiva ou Litisconsórcio Ativo contra a Plataforma ou os seus desenvolvedores originários e prepostos.</p>
             </section>

             <section className="space-y-3 mt-10 pt-10 border-t border-border">
               <h2 className="text-2xl font-bold text-foreground mb-2 pb-2 inline-block">Política de Privacidade</h2>

               <h3 className="text-lg font-bold text-foreground mt-4">Coleta e Tratamento de Dados</h3>
               <p>Coletamos os dados estritamente necessários para o funcionamento lógico do agendamento (nomes, telefones, e-mails). O Profissional é o <strong className="text-foreground">Controlador</strong> dos dados de seus Clientes, e nós somos meros <strong className="text-foreground">Operadores</strong>.</p>

               <h3 className="text-lg font-bold text-foreground mt-4">Seus Deveres LGPD</h3>
               <p>O Profissional concorda em cumprir a LGPD (Lei Geral de Proteção de Dados - Lei 13.709/18) perante seus Clientes. Qualquer infração gerada por contato indevido, vazamento ou mau uso das informações de Clientes do lado do Profissional é de responsabilidade <strong className="text-foreground">exclusiva e integral do Profissional</strong>. Nós ficamos expressamente desobrigados e isentos caso o Profissional incorra em ilícito penal ou cível ao manipular contatos.</p>

               <h3 className="text-lg font-bold text-foreground mt-4">Vazamentos e Ataques (Force Majeure)</h3>
               <p>Empregamos serviços em nuvem padronizados (como Google/Firebase) para manter a plataforma segura. No entanto, não nos responsabilizamos por perdas, vazamentos de dados ou brechas resultantes de ataques de hackers zero-day, falhas nos provedores globais, engenharia social no aparelho dos usuários ou de Força Maior. <strong className="text-foreground">Você trafega dados sensíveis por sua própria conta e risco.</strong></p>

               <h3 className="text-lg font-bold text-foreground mt-4">Foro e Resolução de Disputas</h3>
